...
extern struct posix_acl *cifs_get_dentry_acl(struct user_namespace *mnt_userns,
...
extern int CIFSSMBGetPosixACLLegacy(const unsigned int xid, struct cifs_tcon *tcon,
		const unsigned char *searchName,
		char *acl_inf, const int buflen, const int acl_type,
		const struct nls_table *nls_codepage, int remap_special_chars);
extern int cifs_get_acl(const unsigned int xid, struct cifs_tcon *tcon,
